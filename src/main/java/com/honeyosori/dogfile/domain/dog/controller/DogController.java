...
public class DogController {
    ...
    @PostMapping
    public ResponseEntity<?> registerDog(@Valid @RequestBody RegisterDogDto registerDogDto, @RequestHeader("X-USERNAME") String username) {
        return BaseResponse.getResponseEntity(this.dogService.registerDog(registerDogDto, username));
    }
